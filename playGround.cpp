...
void playGround::soundLoad()
{
	...
	SOUNDMANAGER->addSound("자판기", "mp3/자판기.flac", true, false);
	...
	SOUNDMANAGER->addSound("플레밟기", "mp3/플레밟기.wav", true, false);
	SOUNDMANAGER->addSound("플레맞기", "mp3/플레맞기.mp3", true, false);
	SOUNDMANAGER->addSound("플레슬라이딩펀치", "mp3/플레슬라이딩펀치.wav", true, false);
	SOUNDMANAGER->addSound("게임시작", "mp3/게임시작.mp3", true, false);
	SOUNDMANAGER->addSound("게임오버", "mp3/게임오버.mp3", true, false);
	SOUNDMANAGER->addSound("남자히트", "mp3/남자히트.mp3", true, false);
	SOUNDMANAGER->addSound("보스강펀치", "mp3/보스강펀치.mp3", true, false);
	SOUNDMANAGER->addSound("보스내려찍기", "mp3/보스내려찍기.mp3", true, false);
	SOUNDMANAGER->addSound("보스박치기", "mp3/보스박치기.mp3", true, false);
	SOUNDMANAGER->addSound("보스뺨갈기기", "mp3/보스뺨갈기기.mp3", true, false);
	SOUNDMANAGER->addSound("보스점프엉덩방아", "mp3/보스점프엉덩방아.mp3", true, false);
	SOUNDMANAGER->addSound("보스점프", "mp3/보스점프.mp3", true, false);
	SOUNDMANAGER->addSound("아이템획득", "mp3/아이템획득.mp3", true, false);
	SOUNDMANAGER->addSound("UI선택", "mp3/UI선택.mp3", true, false);
