...
void playGround::imageLoad()
{
	...
	IMAGEMANAGER->addFrameImage("PLAYER_ATTACK1", "image/player/Kyoko_ComboAttack1.bmp", 1548, 469, 6, 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("PLAYER_ATTACK2", "image/player/Kyoko_ComboAttack2.bmp", 1869, 459, 7, 2, true, RGB(255, 0, 255));
	...
	IMAGEMANAGER->addFrameImage("PLAYER_GUARD", "image/player/Kyoko_Guard.bmp", 351, 426, 3, 2, true, RGB(255, 0, 255));
